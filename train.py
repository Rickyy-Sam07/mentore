"""
BERT Model for Chapter Classification
...
from config import *
from dataset_preparation import load_and_preprocess_data, split_data, create_data_loaders
...
def main():
    ...
    model = BertChapterClassifier(num_classes=num_classes)
    ...
    report = classification_report(test_labels, test_preds, target_names=chapter_names, 
    ...
    with open(os.path.join(OUTPUT_DIR, 'training_summary.txt'), 'w') as f:
        f.write(f"BERT Chapter Classification - Training Summary\n")
        f.write(f"{'='*50}\n\n")
