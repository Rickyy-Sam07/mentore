"""
Inference Script for RoBERTa Chapter Classification
...
class RobertaChapterPredictor:
    """Class for making predictions on new text using RoBERTa"""
    ...
    def __init__(self, model_path, label_encoder_path):
        ...
        # Load model
        self.model = RobertaChapterClassifier(num_classes=self.num_classes)
...
def main():
    ...
    if not os.path.exists(model_path):
        ...
        print("Please train the model first by running: python train_roberta.py")
        return
    ...
    print("="*70)
    print("ROBERTA CHAPTER CLASSIFICATION - INFERENCE")
    print("="*70)
    print()
    
    predictor = RobertaChapterPredictor(model_path, label_encoder_path)
